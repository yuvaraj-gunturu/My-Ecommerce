  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10  my-15">
      <div className="min-w-60">
        ...
        <div
          className={`border border-gray-300 pl-5 py-3 mt-3 ${showFilters ? "" : "hidden"} sm:block `}
        >
        ...
        <div
          className={`border border-gray-300 pl-5 py-3 my-3 ${showFilters ? "" : "hidden"} sm:block `}
        >
